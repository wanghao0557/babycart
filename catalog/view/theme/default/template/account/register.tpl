...
<div class="container">
  ...
  <div class="row">
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="babycart-register" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h1 class="hide"><?php echo $heading_title; ?></h1>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          <legend>
            <span><?php echo $text_your_details; ?></span>
          </legend>
        ...
        <fieldset id="address">
          <legend>
            <span><?php echo $text_your_address; ?></span>
          </legend>
          <div class="form-group">
        ...
        <fieldset>
          <legend>
            <span><?php echo $text_your_password; ?></span>
          </legend>
          <div class="form-group required">
        ...
        <div class="form-group">
          <div class="col-sm-offset-4 col-sm-5">
            <input type="submit" value="立即注册" class="btn btn-lg btn-primary" />
          </div>
        </div>
        <?php } else { ?>
        <div class="form-group">
      ...
      <div class="col-sm-3 bform-aside">
